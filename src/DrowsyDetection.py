        ...
        while True:
            ...
            if ret:
                ...
                for rect in rects:
                    ...
                    cv2.drawContours(
                        frame, [leftEyeHull], -1, (0, 200, 124), 1)
                    cv2.drawContours(
                        frame, [rightEyeHull], -1, (0, 200, 124), 1)
                    ...
                    if ear < self.EYE_AR_THRES:
                        ...
                        if self.COUNTER >= self.EYE_AR_CONSEC_FRAME:
                            ...
                            cv2.putText(frame, "DROWSY ALERT", (10, 30),
                                        self.font, 0.5, (255, 0, 0), 2)
                            cv2.imwrite(
                                params['images_folder']+"/"+f"{self.count}.jpg", frame)
                    ...
                    cv2.putText(
                        frame, f"EAR: {round(ear, 2)}", (300, 30), self.font, 0.7, (200, 0, 0), 3)
